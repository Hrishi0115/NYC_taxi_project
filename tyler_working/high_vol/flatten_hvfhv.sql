-- flatten hvfhv incoming tables to apropriate bronze database
...
CREATE OR REPLACE TABLE hvfhv_flat AS 
SELECT
    $1:Hvfhs_liscense_num::STRING AS hvfhs_liscense_num,
    ...
    $1:PULocationID::INT AS pickup_location_id,
    $1:DOLocationID::INT AS dropoff_location_id,
    ...
    $1:shared_request_flag::STRING AS share_request_flag,
...
FROM bronze_layer.json.hvfhv_in
