...
CREATE OR REPLACE TABLE fhvhv_from_2018_in (taxi_col VARIANT);

-- copy staged data into snowflake table
COPY INTO fhvhv_from_2018_in
FROM @all_fhvhv_azure_stage
file_format = parquet_taxis;

-- inspect inserted data
SELECT COUNT(*) FROM fhvhv_from_2018_in;
SELECT * FROM fhvhv_from_2018_in LIMIT 5;
